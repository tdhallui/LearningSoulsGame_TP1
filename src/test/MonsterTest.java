...
public class MonsterTest {
        ...
        try {
            ...
            if (constructor == null) {
                ...
                try {
                    ...
                    Assert.assertTrue("wrong default name (lsg.characters.Monster)", gn.invoke(o) == "lsg.characters.Monster");
                } catch (NoSuchFieldException e) {
    ...
    public void testPrintStats() {
        ...
        try {
            ...
            try {
                ...
                Assert.assertEquals("[ lsg.characters.Monster ]\tLIFE: 10\tSTAMINA: 10\t(ALIVE)\n", str);
            } catch (NoSuchFieldException e) {
                Assert.assertEquals("[ lsg.characters.Monster ]\tlsg.characters.Monster\tLIFE: 10\tSTAMINA: 10\t(ALIVE)\n", outContent.toString());
            }
        } catch (ClassNotFoundException e) {
            Assert.fail("should have a class called lsg.characters.Monster");
        } catch (NoSuchMethodException e) {
    ...
    public void testToString() {
        ...
        try {
            ...
            try {
                ...
                Assert.assertEquals("[ lsg.characters.Monster ]\tLIFE: 10\tSTAMINA: 10\t(ALIVE)", str);
            } catch (NoSuchFieldException e) {
                Assert.assertEquals("[ lsg.characters.Monster ]\tlsg.characters.Monster\tLIFE: 10\tSTAMINA: 10\t(ALIVE)", (String)(ts.invoke(o)));
            }
        } catch (ClassNotFoundException e) {
            Assert.fail("should have a class called lsg.characters.Monster");
        } catch (IllegalAccessException e) {
    ...
    public void testIsAlive() {
        try {
            ...
            Assert.assertTrue("lsg.characters.Monster should be alive", (Boolean)(ia.invoke(o)));
        } catch (ClassNotFoundException e) {
            Assert.fail("should have a class called lsg.characters.Monster");
        } catch (NoSuchMethodException e) {
